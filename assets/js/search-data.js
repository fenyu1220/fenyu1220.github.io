...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "This page contains some basic information about me.",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-efficient-gpt-2-inference-on-fpga-via-hls",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/gpt2/";
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-fpga-co-design-for-n-m-sparse-and-quantized",
          title: 'FPGA Co-Design for N:M Sparse and Quantized',
          description: "Optimizing AI Model with Compression and Accelerator Design",
          section: "Projects",handler: () => {
              window.location.href = "/projects/nmpruning/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%66%65%6E%79%75%39%38%36%37@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/fenyu1220", "_blank");
        },
      },{
        id: 'social-kaggle',
        title: 'Kaggle',
        section: 'Socials',
        handler: () => {
          window.open("https://www.kaggle.com/fenyu1220", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/fenyu1220", "_blank");
        },
      },{
      id: 'light-theme',
